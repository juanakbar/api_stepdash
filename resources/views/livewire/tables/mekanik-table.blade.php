                    ...
                    <td data-label="Actions">
                        <div class="btn-list flex-nowrap">
                            <a data-bs-placement="bottom" title="History Transaksi" class="btn btn-info"
                                href="{{ route('mekaniks.show', $user->id) }}">
                            ...
                            <button data-bs-placement="bottom" title="Edit Mekanik" class="btn btn-warning"
                                data-bs-toggle="modal" data-bs-target="#modal-update-mekanik-{{ $user->id }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            ...
                            <button class="btn btn-danger" data-bs-placement="bottom" title="Hapus Driver"
                                data-bs-toggle="modal" data-bs-target="#modal-delete-mekanik-{{ $user->id }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            ...
                            @include('mekaniks.modal-update')
                            @include('mekaniks.modal-delete')

                        </div>
                    </td>
                </tr>
            @empty
                <x-empty-states title="Data Mekanik Masih Kosong" buttonName="Tambah Mekanik"
                    actionRoute="#modal-add-mekanik" />
            @endforelse
