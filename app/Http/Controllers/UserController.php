...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            flash()->success('User Dengan Username ' . $request->username . ' Berhasil Ditambahkan');
            return redirect()->back();
        } catch (\Exception $e) {
            // Menangani kesalahan dengan mengirimkan pesan error
            flash()->error('Terjadi kesalahan saat memperbarui pengguna: ' . $e->getMessage());
    ...
    public function update(Request $request, User $user)
    {
        try {
            ...
            flash()->success('User Dengan Username ' . $request->username . ' Berhasil Diperbarui');
            return redirect()->back();
        } catch (\Exception $e) {
            // Menangani kesalahan dengan mengirimkan pesan error
            flash()->error('Terjadi kesalahan saat memperbarui pengguna: ' . $e->getMessage());
    ...
    public function destroy(User $user)
    {
        ...
        $user->roles()->detach();
        $user->delete();
        flash()->success('User Dengan Username ' . $user->username . ' Berhasil Dihapus');
        return redirect()->back();
    }
}
